function [fraction,number] = funcname(speciesname,icode)

% http://www.kazusa.or.jp/codon/cgi-bin/showcodon.cgi?species=Aspergillus+fumigatus+%5Bgbpln%5D&aa=1&style=GCG
