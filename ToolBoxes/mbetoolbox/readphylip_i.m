...
% Examples:
%
% >> [aln] = readPhylip('input.phy',1,0,'sequential')   % for non-coding DNA/RNA
% >> [aln] = readPhylip('input.phy',2,1,'sequential')   % for protein-coding DNA
% >> [aln] = readPhylip('input.phy',3,1,'sequential')   % for protein           
%
