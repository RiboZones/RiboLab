function varargout = mbe_dnaml(varargin)
%MBE_DNAML - M-file for mbe_dnaml.fig
%      MBE_DNAML, by itself, creates a new MBE_DNAML or raises the existing
%      singleton*.
%
%      H = MBE_DNAML returns the handle to a new MBE_DNAML or the handle to
%      the existing singleton*.
%
%      MBE_DNAML('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MBE_DNAML.M with the given input arguments.
%
%      MBE_DNAML('Property','Value',...) creates a new MBE_DNAML or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mbe_dnaml_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mbe_dnaml_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @mbe_dnaml_OpeningFcn, ...
                   'gui_OutputFcn',  @mbe_dnaml_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mbe_dnaml is made visible.
function mbe_dnaml_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mbe_dnaml (see VARARGIN)

% Choose default command line output for mbe_dnaml
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mbe_dnaml wait for user response (see UIRESUME)
...
function varargout = mbe_dnaml_OutputFcn(hObject, eventdata, handles)
...
s_ttratio = get(handles.ttratio, 'String');
    optionstr = [optionstr, ' -t', s_ttratio];

i_freqsfromYES = get(handles.freqsfromYES, 'Value');
i_freqsfromNO = get(handles.freqsfromNO, 'Value');
if (i_freqsfromYES==1)
    optionstr = [optionstr, ' -f1'];
else
    optionstr = [optionstr, ' -f0'];
    optionstr = [optionstr, ' -A', get(handles.freqa, 'String')];
    optionstr = [optionstr, ' -C', get(handles.freqc, 'String')];
    optionstr = [optionstr, ' -G', get(handles.freqg, 'String')];
    optionstr = [optionstr, ' -T', get(handles.freqt, 'String')];
end
...
if (exist('mbe_dnaml.fig','file')==2 && exist('mbe_dnaml.m','file')==2),
 
dirstr=chdir2where('mbe_dnaml.m');
if (ispc)
		cmd = 'mbe_dnaml.exe';
...
if (s==0)
	...
	errordlg('Error occurred when running MBE_DNAML.','Running-time Error','modal')
end
...
% --- Executes on button press in freqsfromYES.
function freqsfromYES_Callback(hObject, eventdata, handles)
% hObject    handle to freqsfromYES (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of freqsfromYES
set(handles.freqsfromYES, 'Value', 1);
set(handles.freqsfromNO, 'Value', 0);
set(handles.freqa, 'Enable', 'Off');
set(handles.freqc, 'Enable', 'Off');
set(handles.freqg, 'Enable', 'Off');
set(handles.freqt, 'Enable', 'Off');


% --- Executes on button press in freqsfromNO.
function freqsfromNO_Callback(hObject, eventdata, handles)
% hObject    handle to freqsfromNO (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of freqsfromNO
set(handles.freqsfromYES, 'Value', 0);
set(handles.freqsfromNO, 'Value', 1);
set(handles.freqa, 'Enable', 'On');
set(handles.freqc, 'Enable', 'On');
set(handles.freqg, 'Enable', 'On');
set(handles.freqt, 'Enable', 'On');
...
% --- Executes during object creation, after setting all properties.
function freqc_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freqc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function freqc_Callback(hObject, eventdata, handles)
% hObject    handle to freqc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of freqc as text
%        str2double(get(hObject,'String')) returns contents of freqc as a double


% --- Executes during object creation, after setting all properties.
function freqg_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freqg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function freqg_Callback(hObject, eventdata, handles)
% hObject    handle to freqg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of freqg as text
%        str2double(get(hObject,'String')) returns contents of freqg as a double


% --- Executes during object creation, after setting all properties.
function freqt_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freqt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function freqt_Callback(hObject, eventdata, handles)
% hObject    handle to freqt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of freqt as text
%        str2double(get(hObject,'String')) returns contents of freqt as a double
